...
import { configureOpenClaw, createMachine, ensureGatewayRunning, ensureNode, installOpenClaw, machineEnv, sendGatewayChat, verifyGateway, waitForMachine, writeGatewayStartupScript, exec, } from "./lib.js";
async function main() {
    ...
    const mondayUseCase = await sendGatewayChat(machineId, [
